...
import { SOCIAL_FORMATS, DISPLAY_FORMATS, ExportFormat } from '@/lib/export/formats';
...
export function ExportPanel() {
    ...
    const handleExport = async () => {
        ...
        try {
            const allFormats = [...SOCIAL_FORMATS, ...DISPLAY_FORMATS];
...
function FormatCheckbox({ format, isSelected, onToggle }: { format: ExportFormat, isSelected: boolean, onToggle: () => void }) {
    return (
